export const order = [
  ...
  },
  {
    ...
    options: [
      {
        title: "250g",
        body: "Perfect for the solo drinkers. Yields about 12 delicious cups.",
      },
      {
        title: "500g",
        body: "Perfect option for a couple. Yields about 40 delactable cups.",
      },
      {
        title: "1000g",
  ...
  },
  {
    ...
    options: [
      ...
      {
        title:"Every month",
        body:"$12.00 per shipment. Includes free priorty shipping."
      }
    ],
  },
];
